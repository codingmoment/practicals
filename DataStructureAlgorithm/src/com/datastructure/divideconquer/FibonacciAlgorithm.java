...
/**
 * This program implements algorithm for finding nth number in Fibonacci series using Divide & Conquer (recursion).
 */
public class FibonacciAlgorithm {
  ...
  // Solving the problem using Divide and Conquer approach

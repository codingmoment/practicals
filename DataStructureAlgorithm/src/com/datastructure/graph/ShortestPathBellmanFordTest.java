...
import com.datastructure.graph.algorithm.shortestpath.ShortestPathUsingBellmanFord;
...
public class ShortestPathBellmanFordTest {
  ...
  private static void test1() {
    ...
    ShortestPathUsingBellmanFord algorithm = new ShortestPathUsingBellmanFord();
    algorithm.findShortestPath(adjacency, "E", "B");
    algorithm.findShortestPath(adjacency, "E", "D");
    algorithm.findShortestPath(adjacency, "E", "A");
    algorithm.findShortestPath(adjacency, "E", "C");
  }
  ...
  private static void test2() {
    ...
    ShortestPathUsingBellmanFord algorithm = new ShortestPathUsingBellmanFord();
    algorithm.findShortestPath(adjacency, "A", "B");
    algorithm.findShortestPath(adjacency, "A", "C");
    algorithm.findShortestPath(adjacency, "A", "D");
    algorithm.findShortestPath(adjacency, "A", "E");
    algorithm.findShortestPath(adjacency, "A", "F");
    algorithm.findShortestPath(adjacency, "A", "G");
  }

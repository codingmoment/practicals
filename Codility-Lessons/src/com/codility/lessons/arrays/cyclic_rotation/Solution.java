 ...
 * So, we reduce the given cyclic rotations to actual effective cyclic rotations by using formula:
 * K = K % A.length
 * 
...
public class Solution {
  ...
  public int[] solution(int[] A, int K) {
    ...
    // So, we reduce the given cyclic rotations to actual effective cyclic rotations.
    K = K % A.length;

package com.codility.lessons.counting_elements.max_counters;
  ...
  public int[] solution(int N, int[] A) {
    ...
    for (int operation : A) {
      if (operation <= N) {
        ...
        if (maxValue > 0) { // Added this IF condition to take care of test case where all operations are max operations. 
